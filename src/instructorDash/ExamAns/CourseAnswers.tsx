  ...
  const columns = useMemo(
    () => [
      ...
      columnHelper.display({
        ...
        header: "Actions",
        cell: (props) => {
          const userId = props.row.original.user.id;
          ...
          return (
            <div className="text-gray-700">
              <Button
                ...
                onClick={() => {
                  navigate(
                    `/instruct/courseAnswers/${courseId}/user/${userId}`,
                    {
                      state: {
                        studentName: props.row.original.user.name,
                        studentEmail: props.row.original.user.email,
                      },
                    }
                  );
                }}
