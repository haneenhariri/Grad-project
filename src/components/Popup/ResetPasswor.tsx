...
export default function ResetPasswor() {
  ...
  return (
    <div className='fixed top-0 left-0 w-full h-full flex items-center justify-center bg-black/50'> 
        <form  onSubmit={(e) => {
        e.preventDefault();}} className="bg-white w-max  rounded-md shadow-md md:p-10 p-5  flex flex-col justify-around  gap-5">
        <h2 className="sm:text-3xl text-lg font-bold text-violet-950">Reset Password</h2>
        {step === 1 && (
          <>
            <div>
            ...
            <input
                className="bg-White/95 p-3  w-72 rounded-md border sm:text-base text-sm placeholder:sm:text-base placeholder:text-sm border-violet-950"
                type="email"
