...
useEffect(() => {
  const fetchRate = async () => {
    try {
      ...
      const timeline = (res.timeline || []).map((item: RatingTimelineItem) => ({
        ...item,
...
if (!ratings || !ratings.timeline.length) {
  return <div className="text-center py-10 text-gray-500">Loading rating data...</div>;
}
  ...
  return (
    <div className="bg-white flex flex-col gap-4 justify-between p-4 rounded-lg shadow-sm w-1/2 mx-auto">
      ...
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-lg  text-gray-800 font-semibold">Overall Course Rating</h2>
      ...
      <div className="grid h-full grid-cols-2 gap-6 items-center mb-6">
        <div className="bg-orange-50 h-full flex justify-center items-center flex-col rounded-lg p-4 text-center">
          ...
          <div className="flex justify-center mt-1 mb-1">{renderStars(overall_rating)}</div>
