...
function LoadAfterHero() {
  return (
    <>
      <Suspense fallback={<div>Loading Courses...</div>}><Courses /></Suspense>
      <Suspense fallback={<div>Loading Instructors...</div>}><Instuctor /></Suspense>
      <Suspense fallback={<div>Loading Recommended...</div>}><Recommended /></Suspense>
    </>
  );
}
  ...
  return (
    <>
      ...
      <section className="px-4 lg:px-10 desktop:px-40">
        <Suspense fallback={<div>Loading Categories...</div>}><TopCategory /></Suspense>
        <LoadAfterHero />
      </section>
    </>
  );
