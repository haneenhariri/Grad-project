...
import {
  ...
  getCourseProgress,
} from "../../services/courseProgress"; // تغيير المسار هنا
...
export default function WatchCourse() {
  ...
  const markLessonAsCompleted = async (lessonId: number) => {
    try {
      ...
      showToast(t("CoursesSection.Lesson marked as completed!"), "success");
    } catch (error) {
  ...
  const handleNextLesson = () => {
    ...
    if (currentIndex < course.lessons.length - 1) {
      ...
      // إذا كان هذا آخر درس، يمكنك إما إظهار رسالة أو فعل شيء آخر
      showToast(t("CoursesSection.This is the last lesson"), "info");
    }
  };
  useEffect(() => {
  ...
  return (
    <section className="mb-">
      <Head
        ...
        onNextLesson={handleNextLesson} // أضف هذا السطر
      />
