...
export default function Auth() {
 const location = useLocation();
  return (
    <section className="pt-[150px] rtl:flex-row-reverse desktop:pb-paddingBottom150 md:pb-100 pb-paddingBottom50 px-4 lg:px-20 1600:px-40 flex lg:flex-row flex-col-reverse justify-between gap-y-[50px]">
        <SliderSectionHH/>
