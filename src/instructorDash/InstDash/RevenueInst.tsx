...
import {  revenueStatsInst } from '../../services/dashServe';
...
export default function RevenueInst() {
  ...
  const [revenueType] = useState('total_revenue');
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await revenueStatsInst(periodType);
  ...
  return (
    <div className="p-4 bg-white w-full lg:w-1/2 rounded-lg  shadow-sm">
